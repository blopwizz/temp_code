var resizeableImage = function(image_target) {
  ...
  /************ BUTTONS & INTRERACTIONS *******/
  //select file to edit
  $('.editbtn').click(function(evt) {
    $('.frame1').hide();
    $('.frame2').hide();
    $('.frame3').show();
    $('.picker').find('option:selected').each(function(index, item){
      selectedImage = item;
    });
    logoInGallery = $(selectedImage).attr('data-img-src');
    beginCropLogo();
    $('.resize-image').attr("src", logoInGallery);
  });
  //cancel
...
beginCropLogo = function() {
  image_target.src= logoInGallery;
  orig_src.src=image_target.src;
